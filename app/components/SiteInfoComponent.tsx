  ...
  return (
    <section className={"bg-white dark:bg-gray-900 py-10 "} id={"info"}>
      <div className="mx-auto max-w-screen-md px-4 py-8 lg:py-16 text-center">
        ...
        >
          Take a look &quot;under the hood&quot; to get a closer view of the
          gears turning behind the scenes. Beyond the eye-catching parallax
          header, there&apos;s a bunch of carefully crafted code that brings
          this page to life. Through some thoughtful design, I&apos;ve tried to
